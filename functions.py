...
def generate_grid_dataframe(from_x, to_x, from_y, to_y, inc_x, inc_y, precision):
    """
    This function will generate a grid that would cover the coordinates passed as arguments.
    ...
    precision: state the precision in which the measures are entered. for example, 0,001
